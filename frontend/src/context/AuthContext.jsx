...
export const AuthProvider = ({ children }) => {
  ...
  const checkAuth = async () => {
    try {
      ...
      const response = await axios.get(
        "https://pos-web-system-cvsu.onrender.com/api/user/check-auth", 
  ...
  const login = async (credentials) => {
    try {
      const response = await axios.post(
        "https://pos-web-system-cvsu.onrender.com/api/user/log-in", 
        credentials, 
  ...
  const logout = async () => {
    try {
      await axios.post(
        "https://pos-web-system-cvsu.onrender.com/api/user/log-out", 
        {}, 
        { withCredentials: true } // Pass cookies
      );
